...
class ServarrBase<QueueItemAppendT> extends ExternalAPI {
  ...
  public getSystemStatus = async (): Promise<SystemStatus> => {
    try {
      ...
      throw new Error(
        `[${this.apiName}] Failed to retrieve system status: ${message}`
      );
    }
  };
  ...
  public getProfiles = async (): Promise<QualityProfile[]> => {
    try {
      ...
      const message = e instanceof Error ? e.message : String(e);
      throw new Error(
        `[${this.apiName}] Failed to retrieve profiles: ${message}`
      );
    }
  };
  ...
  public getRootFolders = async (): Promise<RootFolder[]> => {
    try {
      ...
      const message = e instanceof Error ? e.message : String(e);
      throw new Error(
        `[${this.apiName}] Failed to retrieve root folders: ${message}`
      );
    }
  };
  ...
  public getQueue = async (): Promise<(QueueItem & QueueItemAppendT)[]> => {
    try {
      ...
      const message = e instanceof Error ? e.message : String(e);
      throw new Error(
        `[${this.apiName}] Failed to retrieve queue: ${message}`
      );
    }
  };
  ...
  public getTags = async (): Promise<Tag[]> => {
    try {
      ...
      const message = e instanceof Error ? e.message : String(e);
      throw new Error(
        `[${this.apiName}] Failed to retrieve tags: ${message}`
      );
    }
  };
  ...
  public createTag = async ({ label }: { label: string }): Promise<Tag> => {
    try {
      ...
      const message = e instanceof Error ? e.message : String(e);
      throw new Error(`[${this.apiName}] Failed to create tag: ${message}`);
    }
  };
  ...
  public renameTag = async ({
    ...
    try {
      ...
      const message = e instanceof Error ? e.message : String(e);
      throw new Error(`[${this.apiName}] Failed to rename tag: ${message}`);
    }
  };
  ...
  protected async runCommand(
    ...
    try {
      ...
      const message = e instanceof Error ? e.message : String(e);
      throw new Error(`[${this.apiName}] Failed to run command: ${message}`);
    }
  }
}
